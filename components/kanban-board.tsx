                ...
                <div className="px-6 py-4 bg-white border-b flex items-center justify-between shrink-0 gap-4">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="block w-40 pl-3 pr-8 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700 bg-white shadow-sm transition-shadow hover:shadow-md cursor-pointer appearance-none"
